// Écran temporaire valide permettant à React Navigation de monter l'onglet Statistiques.
...
export default function DashboardScreen() {
  return (
    <View style={styles.screen}>
      ...
      <Text style={styles.message}>Les statistiques seront disponibles prochainement.</Text>
    </View>
  );
}
